...
with tf.variable_scope('natural'):
    natural_DQN = DuelingDQN(
        ...
        e_greedy_increment=0.001, sess=sess, dueling=False,double=False,noisy=False,output_graph=True)

with tf.variable_scope('dueling'):
    dueling_DQN = DuelingDQN(
        n_actions=ACTION_SPACE, n_features=3, memory_size=MEMORY_SIZE,
        e_greedy_increment=0.001, sess=sess, dueling=True ,double=False,noisy=True,output_graph=True)
